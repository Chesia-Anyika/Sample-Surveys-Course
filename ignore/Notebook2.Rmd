...
```{r}
#load data from SDAresources package
data(agstrat)
...
```{r}
unique(agstrat$region) #unique entries in the region column
```
...
```{r}
boxplot(acres87/10^6 ~ region, xlab = "Region", ylab = "Millions of Acres",
data = agstrat)
```
